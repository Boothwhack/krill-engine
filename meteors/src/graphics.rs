...
impl Vertex {
    pub const fn new(position: Point3<f32>, color: Color) -> Self {
...
const SHIP_VERTICES: [Vertex; 4] = [
    Vertex::new(point!(-0.3, -0.3, 0.0), Color::WHITE),
    Vertex::new(point!(0.0, -0.2, 0.0), Color::WHITE),
    Vertex::new(point!(0.0, 0.3, 0.0), Color::WHITE),
    Vertex::new(point!(0.3, -0.3, 0.0), Color::WHITE),
];
...
const BULLET_VERTICES: [Vertex; 4] = [
    Vertex::new(point!(0.04, -0.08, 0.0), Color::WHITE),
    Vertex::new(point!(0.04, 0.08, 0.0), Color::WHITE),
    Vertex::new(point!(-0.04, -0.08, 0.0), Color::WHITE),
    Vertex::new(point!(-0.04, 0.08, 0.0), Color::WHITE),
];
...
const ARROW_VERTICES: [Vertex; 36] = [
    Vertex::new(point!(-0.5, -ARROW_HEIGHT, 0.0), Color::WHITE),
    Vertex::new(point!(-0.5, -ARROW_HEIGHT + ARROW_WIDTH, 0.0), Color::WHITE),
    Vertex::new(point!(0.0, ARROW_HEIGHT - ARROW_WIDTH, 0.0), Color::WHITE),
    Vertex::new(point!(-0.5, -ARROW_HEIGHT + ARROW_WIDTH, 0.0), Color::WHITE),
    Vertex::new(point!(0.0, ARROW_HEIGHT - ARROW_WIDTH, 0.0), Color::WHITE),
    Vertex::new(point!(0.0, ARROW_HEIGHT, 0.0), Color::WHITE),
    Vertex::new(point!(0.0, ARROW_HEIGHT - ARROW_WIDTH, 0.0), Color::WHITE),
    Vertex::new(point!(0.0, ARROW_HEIGHT, 0.0), Color::WHITE),
    Vertex::new(point!(0.5, -ARROW_HEIGHT, 0.0), Color::WHITE),
    Vertex::new(point!(0.0, ARROW_HEIGHT, 0.0), Color::WHITE),
    Vertex::new(point!(0.5, -ARROW_HEIGHT, 0.0), Color::WHITE),
    Vertex::new(point!(0.5, -ARROW_HEIGHT + ARROW_WIDTH, 0.0), Color::WHITE),
    Vertex::new(point!(-1.0, 1.0, 0.0), Color::WHITE),
    Vertex::new(point!(-0.8, 0.8, 0.0), Color::WHITE),
    Vertex::new(point!(1.0, 1.0, 0.0), Color::WHITE),
    Vertex::new(point!(-0.8, 0.8, 0.0), Color::WHITE),
    Vertex::new(point!(1.0, 1.0, 0.0), Color::WHITE),
    Vertex::new(point!(0.8, 0.8, 0.0), Color::WHITE),
...
const SPACEBAR_VERTICES: [Vertex; 42] = [
    Vertex::new(point!(-0.6, 0.3, 0.0), Color::WHITE),
    Vertex::new(point!(-0.4, 0.3, 0.0), Color::WHITE),
    Vertex::new(point!(-0.6, -0.3, 0.0), Color::WHITE),
    Vertex::new(point!(-0.4, 0.3, 0.0), Color::WHITE),
    Vertex::new(point!(-0.6, -0.3, 0.0), Color::WHITE),
    Vertex::new(point!(-0.4, -0.1, 0.0), Color::WHITE),
    Vertex::new(point!(-0.6, -0.3, 0.0), Color::WHITE),
    Vertex::new(point!(-0.4, -0.1, 0.0), Color::WHITE),
    Vertex::new(point!(0.6, -0.3, 0.0), Color::WHITE),
    Vertex::new(point!(-0.4, -0.1, 0.0), Color::WHITE),
    ...
    Vertex::new(point!(0.6, 0.3, 0.0), Color::WHITE),
    Vertex::new(point!(0.4, 0.3, 0.0), Color::WHITE),
    Vertex::new(point!(-3.0, 1.0, 0.0), Color::WHITE),
    Vertex::new(point!(-2.8, 0.8, 0.0), Color::WHITE),
    Vertex::new(point!(3.0, 1.0, 0.0), Color::WHITE),
    Vertex::new(point!(-2.8, 0.8, 0.0), Color::WHITE),
    Vertex::new(point!(3.0, 1.0, 0.0), Color::WHITE),
    Vertex::new(point!(2.8, 0.8, 0.0), Color::WHITE),
